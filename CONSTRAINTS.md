...
| `r.SkipBody()` | yes | Closes body channel immediately; subsequent chunks forwarded without buffering. Must call for header-only filters to avoid stalling the worker thread |
